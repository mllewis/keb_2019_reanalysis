...
LANG_DISTANCE_OUTPATH <- here("data/processed/animal_shape_distances_language_google.csv")
SHAPE_SIM_PATH <- here("data/processed/animal_shape_vectors_google.csv")
