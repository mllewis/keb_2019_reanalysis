...
OUTPATH <- here("data/processed/cached_vectors_coca.csv")
TARGET_WORDS <- here("data/processed/words_to_cache.csv")
MODEL_PATH <- "/Users/mollylewis/Downloads/all_coca.vec" #"/Volumes/wilbur_the_great/fasttext_models/wiki.en.vec" 
