...
LANG_VECTORS <- here("data/processed/animal_color_raw_vectors_sub.csv")
TIDY_HUMAN_PATH <- here("data/processed/tidy_human_data.csv")
DESC_COLORS <-  here('data/raw/animal_color_descriptions.csv')
OUTPATH <- here("data/processed/animal_color_vectors_sub.csv")
NORM_TYPE <- "raw"
