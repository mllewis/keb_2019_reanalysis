...
LANG_DISTANCE_OUTPATH <- here("data/processed/animal_color_distances_language_google.csv")
COLOR_SIM_PATH <- here("data/processed/animal_color_vectors_google.csv")
